...
import { Controller, Get, Patch, UseGuards, Request, Logger, Post, Body, ValidationPipe, HttpCode, HttpStatus, NotFoundException } from '@nestjs/common';
...
export class UsersController {
  ...
  async getProfile(@Request() req) {
      ...
      // Destructuring khi chắc chắn user không null
  ...
  @UseGuards(JwtAuthGuard)
  @Patch('profile') // Thêm endpoint PATCH
